...
import { quiLessonsB1, quiLessonsB2, quiLessonsB3, quiLessonsB4 } from './data_grade3_quimica';
import { fisLessonsB1, fisLessonsB2, fisLessonsB3, fisLessonsB4 } from './data_grade3_fisica';
import { bioLessonsB1, bioLessonsB2, bioLessonsB3, bioLessonsB4 } from './data_grade3_biologia';
import { porLessonsB1, porLessonsB2, porLessonsB3, porLessonsB4 } from './data_grade3_portugues';
import { redLessonsB1, redLessonsB2, redLessonsB3, redLessonsB4 } from './data_grade3_redacao';
import { ingLessonsB1, ingLessonsB2, ingLessonsB3, ingLessonsB4 } from './data_grade3_ingles';
import { artLessonsB1, artLessonsB2, artLessonsB3, artLessonsB4 } from './data_grade3_artes';
import { efLessonsB1, efLessonsB2, efLessonsB3, efLessonsB4 } from './data_grade3_educacao_fisica';
import { matLessonsB1, matLessonsB2, matLessonsB3, matLessonsB4 } from './data_grade3_matematica';
